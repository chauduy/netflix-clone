                ...
                <div className="lg:mx-auto lg:max-w-6xl">
                    ...
                    <div className="grid grid-cols-12 border-[1px] border-white/70 p-4 lg:border-2 lg:border-l-0 lg:border-r-0 lg:border-white/100 lg:px-0">
                        <div className="col-span-12 lg:col-span-3 lg:pr-16">
                            ...
                            <button className="w-60 bg-[#f1f1f1] py-2 text-sm lg:text-base font-bold text-black lg:w-full h-[52px] flex items-center justify-center" onClick={manageSubscription}>
                                {loading ? <CircularProgress  className="!text-[#E50914] !h-6 !w-6"/> : 'Cancel Membership'}
                            </button>
                        </div>
                            ...
                            <p className="text-sm text-white">
                                {
                                    products?.find(
                                        (item) =>
                                            item?.id === subscription?.product
                                    )?.name
                                }
                            </p>
                            <div className="lg:text-right">
                                <button className="membershipLink" onClick={changePlan}>
                                    Change plan
                                </button>
                            </div>
                        </div>
